        ...
        <section className="py-24 px-6">
          <div className="max-w-6xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl font-bold text-white mb-4">Why Choose Our Web Design?</h2>
        ...
        <section className="py-24 px-6 bg-gradient-to-r from-blue-500/5 to-purple-500/5">
          <div className="max-w-6xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl font-bold text-white mb-4">Web Design Packages</h2>
        ...
        <section className="py-24 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-300 text-lg">What our clients say about our web Design services</p>
            </motion.div>
