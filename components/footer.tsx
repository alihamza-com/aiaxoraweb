...
const footerLinks = {
  ...
  technologies: [
    { name: "React & Next.js", href: "/", icon: Code },
    { name: "Node.js & Python", href: "/", icon: Database },
    { name: "Cloud Solutions", href: "/", icon: Cloud },
    { name: "AI & Machine Learning", href: "/", icon: Cpu },
    { name: "Mobile Development", href: "/", icon: Smartphone },
    { name: "Security & Performance", href: "/", icon: Lock },
  ],
  company: [
  ...
  resources: [
    ...
    { name: "Free Tools & Resources", href: "/" },
